= Monolithic to Microservices based Cloud Native Apps 
...
----
$ cd cities-service
$ cf check-route <first-initial><last-initial>-cities-mono cfapps.io
$ cf push <first-initial><last-initial>-cities-mono -i 1 -m 512M -p build/libs/cities-monolithic.jar
----
+
* Be sure to name your application '<first-initial><last-initial>-cities-mono'

. Verify you can access your application from a Web Browser `http://<first-initial><last-initial>-cities-mono.cfapps.io`
...
[source,bash]
----
$ cf logs <first-initial><last-initial>-cities-mono.cfapps.io 
----
...
[source,bash]
----
$ curl -i http://<first-initial><last-initial>-cities-mono.cfapps.io/cities/10
----
...
[source,bash]
----
$ cf events <first-initial><last-initial>-cities-mono
----

To view the health of the application you can see from the App Manager or from the cli:
[source,bash]
----
$ cf app <first-initial><last-initial>-cities-mono
----
...
[source,bash]
----
$ cf env <first-initial><last-initial>-cities-mono
----
